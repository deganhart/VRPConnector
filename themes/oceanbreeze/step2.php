...
<div class="vrpgrid_6 userbox alpha " id="newuserbox">
    ...
    <div class="padit">
        ...
        <br><br><br>
        <a href="/vrp/book/step3/?obj[Arrival]=<?php echo  $data->Arrival; ?>&obj[Departure]=<?php echo  $data->Departure; ?>&obj[PropID]=<?php echo  $_GET['obj']['PropID']; ?>" class="bookingbutton rounded">Continue with Reservation</a>
        </br>        </div>
