        ...
        <div style="padding:10px;">
            <ul class="advancedlist">
                <?php foreach ($searchoptions->locations as $v){ ?>
                    <li><input type="checkbox" name="search[location][]" value="<?php echo $v;?>" /><label><?php echo $v;?></label></li>
                <?php } ?>
        ...
        <div class="ui-widget-header ui-corner-all">
            ...
            <ul class="advancedlist">
                <?php foreach ($searchoptions->attrs as $v){ ?>
                    <li><input type="checkbox" name="search[attrs][]" value="<?php echo $v;?>" /><label><?php echo $v;?></label></li>
                <?php } ?>
